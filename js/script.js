...
let levels = [
    ...
    },
    {
        ...
        creator: 'GabestGD',
        rating: 4,
        image: '../imagenes/nuclearalarm.png'
    },
    {
        id: 'jetpacktrials',
        name: 'Jetpack Trials',
...
function renderLevels() {
    ...
    if (isAdminMode) {
        content += `<div class="admin-controls">
            <a href="../html/addrated.html" class="add-level-btn">Add New Level</a>
        </div>`;
    }
